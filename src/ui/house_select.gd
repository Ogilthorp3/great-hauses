...
const OPPONENTS: Array[Dictionary] = [
	...
	{"kind": "jedi_council", "council_mode": "jedi_council",
		"label": "⚔️ The Jedi Council of Sanctum", "desc": "Consensus of Master Qwen 3.8, DeepSeek Flash, Stockfish & Leela"},
	...
	{"kind": "jedi_council", "council_mode": "deepseek_flash",
		"label": "🔮 The Oracle (DeepSeek Flash)", "desc": "Mystic Seer: deep positional pondering and intuitive pawn storms"},
	...
	{"kind": "ds4_oracle", "level": "max_thinking", "oracle_mode": "pure",
		"label": "Pure Oracle", "desc": "Deep neural evaluation and positional mastery"},
	{"kind": "ds4_oracle", "level": "max_thinking", "oracle_mode": "counseled",
		"label": "Counseled Oracle", "desc": "Neural vision guided by grandmaster principles"},
	{"kind": "ds4_oracle", "level": "max_thinking", "oracle_mode": "maester",
		"label": "Oracle + Grand Maester", "desc": "Full Stockfish depth fused with neural intuition"},
